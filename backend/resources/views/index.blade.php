				...
				<div class="row">
											...
											<ul id="tasks" class="item-list ui-sortable">
												<li class="item-orange clearfix ui-sortable-handle">
													...
													<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42" style="height: 30px; width: 30px; line-height: 29px;">
														<span class="percent">42</span>%
														<canvas height="46" width="46" style="height: 30px; width: 30px;"></canvas></div>
													</li>
					...
					<div class="col-sm-6">
						<div class="widget-box">
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									<div class="dialogs ace-scroll"><div class="scroll-track scroll-active" style="display: block; height: 300px;"><div class="scroll-bar" style="height: 213px; top: 86px;"></div></div><div class="scroll-content" style="max-height: 300px;">
